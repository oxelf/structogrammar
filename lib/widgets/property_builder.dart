...
import 'package:structogrammar/widgets/property_list.dart';
        ...
        switch (widget.property.propertyType) {
          case PropertyType.string:
            return PropertyTextfield(
              fieldName: "",
              value: widget.property.propertyValue,
              maxLines: 5,
              onChanged: (value) {
          ...
          case PropertyType.int:
            return PropertyTextfield(
              fieldName: "",
              onlyInt: true,
              value: widget.property.propertyValue.toString(),
              onChanged: (value) {
                widget.onChanged.call(widget.property.propertyKey,
                    int.tryParse(value) ?? widget.property.propertyValue);
              },
            );
          case PropertyType.dropdown:
            return PropertyDropdown(
                possibleValues: widget.property.possibleValues ??
                    [widget.property.propertyValue],
                value: widget.property.propertyValue,
                onChanged: (value) {
                  widget.onChanged.call(widget.property.propertyKey, value);
                });
          ...
          case PropertyType.list:
            return PropertyListWidget(
                ...
                onChanged: (value) {
                  print("on changed");
                  widget.property.onChanged?.call(value);
                  //widget.onChanged.call(widget.property.propertyKey, value);
                });
          default:
            return PropertyTextfield(
